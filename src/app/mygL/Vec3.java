...
import dependence.math.QuickMath;
import dependence.math.functable.TrigonometricTable;
...
public final class Vec3 {
    ...
    public Vec3 rotate_X(int angle){
        float sin = TrigonometricTable.sin(angle);
        float cos = TrigonometricTable.cos(angle);
        float old_Y = y;
        float old_Z = z;
